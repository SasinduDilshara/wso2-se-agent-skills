...
user-invocable: true
argument-hint: "(reads from .ai/issue-analysis.md)"
---
...
4. Check `git status`. If there are uncommitted changes, warn the developer and ask whether to proceed, stash changes, or abort.
...
If a previous version of `.ai/implementation-plan.md` exists (e.g., from a prior `/plan-fix` run), increment the version number and add an entry to the `## Revision History` section describing what changed and why. Warn the developer that any downstream artifacts (e.g., `plan-review-report.md`) were generated against a previous version and should be re-run.
...
## Metadata
- **Generated by:** /plan-fix
- **Timestamp:** [ISO 8601 timestamp]
- **Issue:** #[ID]
- **Repository:** [owner/repo]
- **Version:** [1, or increment if revising]
